export function Bootstrap(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      className="iconCard"
    ...
    >
      <g fill="none">
        <rect
          width="256"
          height="256"
          fill="url(#IconifyId19ba9be8114e1f48f0)"
          rx="60"
        />
        <g filter="url(#IconifyId19ba9be8114e1f48f2)">
          <path
            fill="url(#IconifyId19ba9be8114e1f48f1)"
        ...
        <defs>
          <linearGradient
            id="IconifyId19ba9be8114e1f48f0"
            x1="0"
            x2="256"
            y1="0"
            y2="256"
          ...
          <linearGradient
            id="IconifyId19ba9be8114e1f48f1"
            x1="85.793"
            x2="148.541"
            y1="68.962"
            y2="175.084"
          ...
          <filter
            id="IconifyId19ba9be8114e1f48f2"
            width="137.529"
            height="170.157"
            x="59"
            y="47"
